...
| **Pré-condições:**  | Deve-se ter cadastrado no sistema pelo menos um torneio, um circuito.    |
...
| **Comportamento esperado:**   | Ao verificar a existencia de cadastro de um dos jogadores, deve-se ao invés de realizar um novo cadastro faz uso do cadastro antigo.    |
| **Pós-condições:**   | Deve-se salvar a inscrição e atualizar o status da dupla na competição, bem como fazer a soma de pontos.    |
